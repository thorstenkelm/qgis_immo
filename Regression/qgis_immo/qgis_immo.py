...
class gqisImmo:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('gqisImmo', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qgis_immo/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'QGIS Immo'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            if len(target_field) == 0:
                ...
                msg.setText("No target field selected.")
            ...
            if len(selected_fields) == 0:
                ...
                msg.setIcon(QMessageBox.Warning)
                msg.setWindowTitle("Warning")
                msg.setText("No fields selected to use for the regression analysis.")
                msg.setStandardButtons(QMessageBox.Ok)
                msg.exec_()
                return
